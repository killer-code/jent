  ...
  <section class="screen-six">
    <div class="container">
      ...
      <section class="content page-1-content">
        <h2 class="caption-2">Страница не найдена</h2>

        <div class="_mt-7">
            <p class="txt txt_left">
              По вашему запросу ничего не найдено. Возможно 
              <br class="mb_d-none">
              страницы больше не существует или адрес был введен 
              <br class="mb_d-none">
              не верно.
            </p>
          </div>
...
.screen-six {
  ...
  @media screen and (max-width: 560px) {
    ...
    background-image: url('~@/assets/img/static/bg-s6-mob.png');
    background-size: 85%;
