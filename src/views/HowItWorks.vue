<template>
  <section class="how-it-works">
    <div class="how-it-works__container">
      ...
      <p class="subtitle">
        Джент &mdash; инновационный продукт в формате удобного спрея для приема
        внутрь. Для получения мощной эрекции достаточно двух нажатий, препарат
        действует через 10 минут. В одном флаконе содержится 32 дозы применения.
      </p>
      ...
      <div class="description">
        ...
        <div class="description__content">
          <p>
            ...
            приток крови к половому органу. По завершении полового акта орган
